...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Добавить категорию для точек</h1>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input name="name_cat_s" type="text" class="form-control" id="admin-categories-name_s" placeholder="Название в множественном числе">
            </div>
